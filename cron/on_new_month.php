<?php
/**
 * Crontab задание выполняющееся каждый новый месяц
 *
...
\Ms\Core\Lib\Logs::write2Log('Запуск события OnNewMonth');

\Ms\Core\Lib\Events::runEvents('ms.dobrozhil','OnNewMonth');
